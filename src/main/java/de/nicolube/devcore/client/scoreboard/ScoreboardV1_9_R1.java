...
public final class ScoreboardV1_9_R1 extends ScoreBoard{

    private final net.minecraft.server.v1_9_R1.Scoreboard board;
    private final ScoreboardObjective objective;

    public ScoreboardV1_9_R1(Player player, String titel, String[] content) {
        super(player, content);
        this.board = new net.minecraft.server.v1_9_R1.Scoreboard();
        ...
        Reflectorv1_9_R1.sendPacket(player, objectivPacket);
        Reflectorv1_9_R1.sendPacket(player, display);
    ...
    protected void removeScore(String string) {
        ...
        Reflectorv1_9_R1.sendPacket(player, packet);
    }
    ...
    protected void addScore(String string, int score) {
        ...
        Reflectorv1_9_R1.sendPacket(player, new PacketPlayOutScoreboardScore(sScore));
    }
}
